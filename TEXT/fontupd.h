...
u32 fupd_prog(u16 x,u16 y,u8 size,u32 fsize,u32 pos,u16 point_color,u16 back_color);	//显示更新进度
u8 updata_fontx(u16 x,u16 y,u8 size,u8 *fxpath,u8 fx,u16 point_color,u16 back_color);	//更新指定字库
u8 update_font(u16 x,u16 y,u8 size,u16 point_color,u16 back_color);					//更新全部字库
