...
void LCD_ShowChar(u16 x,u16 y,u8 num,u8 size,u8 mode,u16 point_color,u16 back_color,u16 ms);						//显示一个字符
void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size,u16 point_color,u16 back_color,u16 ms);  						//显示一个数字
void LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode,u16 point_color,u16 back_color,u16 ms);				//显示 数字
void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p,u16 point_color,u16 back_color,u16 ms);		//显示一个字符串,12/16字体
...
#define table_x 240
#define table_y 50
extern u8 table[table_x][table_y];
